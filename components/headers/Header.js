...
import BraveBrowser from "../svgs/BraveBrowser.js";
  ...
  return (
    <>
      <div className={"bg-blue-500 flex justify-between items-center"}>
        ...
        >
          <Link href="/login" >
            <a className={"px-3 py-2 hover:underline transition-all duration-500 ease-in-out hover:-translate-y-1"}>Login</a>
          </Link>
          <Link href="/signup" >
					<a className={"px-3 py-2 hover:underline transition-all duration-500 ease-in-out hover:-translate-y-1"}>Signup</a>
					</Link>
					<div className={"flex items-center text-black bg-blue-300 px-2 py-1 rounded-full space-x-2"}>
